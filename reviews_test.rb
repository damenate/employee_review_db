...
ReviewMigration.migrate(:down) rescue false
ReviewMigration.migrate(:up) rescue false
...
class ReviewsTest < Minitest::Test
  ...
  def test_get_department_salary
    ...
    employee2 = Employee.create(name: "Link", email: "link@example.com", phone: "882-329-3843", salary: 150000)
    development = Department.create(name: "Avengers")
  ...
  def test_employees_can_be_reviewed
    employee = Employee.create(name: "Joanna", email: "jdark@example.com", phone: "515-888-4821", salary: 80000)
    employee.review = "She does her job well!"
    assert "She does her job well!", employee.review
  end
  ...
  def test_whole_departments_can_get_raises
    employee = Employee.create( name: "Joanna", email: "jdark@example.com", phone: "515-888-4821", salary: 80000)
    employee2 = Employee.create( name: "Link", email: "link@example.com", phone: "882-329-3843", salary: 150000)
    employee3 = Employee.create( name: "Sonic", email: "sonic@example.com", phone: "333-444-5555", salary: 20000)
    development = Department.create(name: "Avengers")
    development.add_employee(employee)
    development.add_employee(employee2)
